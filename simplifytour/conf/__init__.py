...
def register_setting(name=None, label=None, editable=False, description=None,
    ...
    """
    if name is None:
        raise TypeError("simplifytour.conf.register_setting requires the "
...
class Settings(object):
    ...
    def _load(self):
        ...
        """
        from simplifytour.conf.models import Setting
...
mezz_first = lambda app: not app.startswith("simplifytour.")
