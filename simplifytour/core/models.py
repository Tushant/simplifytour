...
from simplifytour.utils.urls import admin_url, slugify, unique_slug
from simplifytour.core.managers import DisplayableManager
from simplifytour.utils.models import base_concrete_model
from simplifytour.generic.fields import KeywordsField
from simplifytour.core.fields import RichTextField, OrderField
from simplifytour.utils.html import TagCloser
...
class Slugged(SiteRelated):
    ...
    def admin_link(self):
        return format_html("<a href=''>Admin Link</a>")
            ...
            if not description:
                for field in self._meta.get_fields():
                    if (isinstance(field, field_type) and
                        ...
                        if description:
                            from simplifytour.core.templatetags.simplifytour_tags \
...
class Displayable(Slugged, MetaData, TimeStamped):
    ...
    website such as publishing fields. Basis of simplifytour pages,
