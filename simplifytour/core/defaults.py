# """
# Default settings for the ``simplifytour.core`` app. Each of these can be
...
# from simplifytour.conf import register_setting
...
#         "(eg: ``['simplifytour.blog.models.BlogPost',]``) that should be "
...
#     description=_("simplifytour's caching uses a technique know as mint "
...
# # if "simplifytour.blog" in settings.INSTALLED_APPS:
# #     dashboard_tags = (
# #         ("blog_tags.quick_blog", "simplifytour_tags.app_list"),
# #         ("comment_tags.recent_comments",),
# #         ("simplifytour_tags.recent_actions",),
# #     )
# # else:
# #     dashboard_tags = (
# #         ("simplifytour_tags.app_list",),
# #         ("simplifytour_tags.recent_actions",),
# #         (),
# #     )
...
#         "simplifytour's (or any library's) models. Each item in the sequence is "
...
#                   "simplifytour/core/static/simplifytour/js/"),
#     editable=False,
...
#     editable=False,
#     default="simplifytour.core.forms.TinyMceWidget",
# )
...
#     editable=False,
#     default=("simplifytour.utils.html.thumbnails",),
# )
...
#         "``simplifytour.core.models.Displayable`` should be used."),
#     editable=False,
...
# register_setting(
#     name="SITE_PREFIX",
#     description=_("A URL prefix for mounting all of simplifytour's urlpatterns "
#         "under. When using this, you'll also need to manually apply it to "
#         "your project's root ``urls.py`` module. The root ``urls.py`` module "
#         "provided by simplifytour's ``simplifytour-project`` command contains an "
...
#         "``simplifytour.utils.urls.slugify_unicode`` which allows for non-ascii "
#         "URLs. Change to ``django.template.defaultfilters.slugify`` to use "
#         "Django's slugify function, or something of your own if required."),
#     editable=False,
#     default="simplifytour.utils.urls.slugify_unicode",
# )
...
#         "Defaults to ``simplifytour.utils.views.is_spam_akismet`` which will "
#         "use the http://akismet.com spam filtering service when the "
#         "``AKISMET_API_KEY`` setting is configured."),
#     editable=False,
#     default=("simplifytour.utils.views.is_spam_akismet",),
# )
...
#     editable=False,
#     default="simplifytour/js/tinymce_setup.js",
# )
...
# # available settings. They are simplifytour specific, but their values
...
#         "automatically generated by the ``simplifytour-project`` command."),
#     editable=False,
#     default="",
# )
