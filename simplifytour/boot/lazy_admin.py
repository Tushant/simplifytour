...
class LazyAdminSite(AdminSite):
    ...
    def urls(self):
        ...
        # Misc simplifytour urlpatterns that should reside under /admin/ url,
        # specifically for compatibility with SSLRedirectMiddleware.
        from simplifytour.core.views import displayable_links_js, static_proxy
        from simplifytour.generic.views import admin_keywords_submit
        urls += [
        ...
        if "simplifytour.pages" in settings.INSTALLED_APPS:
            from simplifytour.pages.views import admin_page_ordering
