...
from simplifytour.pages.models import Page, PageMoveException
...
def page(request, slug, template=u"pages/page.html", extra_context=None):
    ...
    ``simplifytour.pages.middleware.PageMiddleware``. The page is loaded
    ...
    if not PageMiddleware.installed():
        raise ImproperlyConfigured("simplifytour.pages.middleware.PageMiddleware "
