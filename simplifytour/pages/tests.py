...
# from simplifytour.core.models import CONTENT_STATUS_PUBLISHED
# from simplifytour.core.request import current_request
# from simplifytour.pages.models import Page, RichTextPage
# from simplifytour.pages.admin import PageAdminForm
# from simplifytour.pages.fields import MenusField
# from simplifytour.pages.checks import check_context_processor
# from simplifytour.urls import PAGES_SLUG
# from simplifytour.utils.sites import override_current_site_id
# from simplifytour.utils.tests import TestCase
...
#         from simplifytour.core.request import _thread_local
...
#         accounts_installed = ("simplifytour.accounts" in settings.INSTALLED_APPS)
...
#             # For an inaccessible page with simplifytour.accounts we should
...
#         if accounts_installed:
#             with override_settings(LOGIN_URL="simplifytour.accounts.views.login"):
#                 response = self.client.get(public_url, follow=True)
#                 self.assertEqual(response.status_code, 200)
#                 response = self.client.get(private_url, follow=True)
#                 self.assertEqual(response.status_code, 200)
...
#         python 2.x
#         """
#         from simplifytour.pages.page_processors import processor_for
...
#         """
#         from simplifytour.pages.middleware import PageMiddleware
#         from simplifytour.pages.page_processors import processor_for
#         from simplifytour.pages.views import page as page_view
...
#         from simplifytour.utils.urls import slugify
...
#         context_processor = 'simplifytour.pages.context_processors.page'
