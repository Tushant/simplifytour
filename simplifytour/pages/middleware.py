...
from simplifytour.pages import context_processors, page_processors
from simplifytour.pages.models import Page
# from simplifytour.pages.views import page as page_view
from simplifytour.utils.conf import middlewares_or_subclasses_installed
from simplifytour.utils.deprecation import (MiddlewareMixin, is_authenticated)
...
class PageMiddleware(MiddlewareMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if "simplifytour.pages" not in settings.INSTALLED_APPS:
            raise MiddlewareNotUsed

    @classmethod
    def installed(cls):
        """
        Used in ``simplifytour.pages.views.page`` to ensure
        ...
        try:
            ...
            name = "simplifytour.pages.middleware.PageMiddleware"
    ...
    #     # If the view isn't simplifytour's page view, try to return the result
    #     # immediately. In the case of a 404 with an URL slug that matches a
    #     # page exactly, swallow the exception and try simplifytour's page view.
    #     #
    ...
    #     # and subsequently be rendered by simplifytour's page view.
